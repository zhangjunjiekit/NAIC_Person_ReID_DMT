...
# Name of backbone
_C.MODEL.NAME = 'resnet101_ibn_b'
# Last stride of backbone
_C.MODEL.LAST_STRIDE = 1
# Path to pretrained model of backbone
_C.MODEL.PRETRAIN_PATH = '../model/resnet101_ibn_b.pth'
...
_C.MODEL.ID_LOSS_TYPE = 'Linear'
_C.MODEL.ID_LOSS_WEIGHT = 1.0
_C.MODEL.TRIPLET_LOSS_WEIGHT = 1.0
_C.MODEL.WEIGHTED_TRIPLET = True
_C.MODEL.THRESH = 0.3
# -----------------------------------------------------------------------------
# INPUT
# -----------------------------------------------------------------------------
...
# Root directory where sets should be used (and downloaded if not found)
...
_C.SOLVER.CENTER_LOSS_WEIGHT = 0.003
...
_C.TEST.WEIGHT = './ckp/resnet101_ibn_a_50.pth'
...
_C.OUTPUT_DIR = "./ckp/resnet101_ibn_b"
